...
def check_files_status():
    ...
    files_to_check = [
        ...
        (os.path.join(BASE_DIR, "script", "po.py"), "📅 Script Planned Occupation"),
        (os.path.join(BASE_DIR, "script", "tbh.py"), "👤 Script To Be Hired")
    ]
...
def main():
    while True:
        try:
            ...
            if choice == "1":
                run_script("po.py", "Planned Occupation Date", "📅")

            elif choice == "2":
                run_script("tbh.py", "To Be Hired", "👤")
